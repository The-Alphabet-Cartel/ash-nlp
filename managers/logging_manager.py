...
class LoggingConfigManager:
    ...
    def __init__(self, unified_config_manager):
        ...
        try:
            ...
            self.logging_config = self.unified_config.get_config_section(
                "logging_settings"
            )
            logger.info(
                "LoggingConfigManager v3.1e-5.5 initialized - Phase 3e patterns applied"
            )
    ...
    def get_global_logging_settings(self) -> Dict[str, Any]:
        ...
        try:
            ...
            global_settings = self.unified_config.get_config_section(
                "logging_settings", "global_settings", {}
            )
            ...
            return {
                ...
                "enable_console_output": global_settings.get(
    ...
    def is_console_output_enabled(self) -> bool:
        ...
        try:
            global_settings = self.get_global_logging_settings()
            return self._safe_bool_conversion(
                global_settings.get("enable_console_output", True)
            )
        except Exception as e:
    ...
    def is_file_output_enabled(self) -> bool:
        ...
        try:
            global_settings = self.get_global_logging_settings()
            return self._safe_bool_conversion(
                global_settings.get("enable_file_output", True)
            )
        except Exception as e:
    ...
    def get_detailed_logging_settings(self) -> Dict[str, Any]:
        ...
        try:
            # PHASE 3E: Enhanced access using get_config_section patterns
            detailed_settings = self.unified_config.get_config_section(
                "logging_settings", "detailed_logging", {}
            )
            ...
            return {
                ...
                "performance_metrics": detailed_settings.get(
    ...
    def is_detailed_logging_enabled(self) -> bool:
        ...
        try:
            ...
            return self._safe_bool_conversion(
                detailed_settings.get("enable_detailed", True)
            )
        except Exception as e:
    ...
    def should_include_raw_labels(self) -> bool:
        ...
        try:
            detailed_settings = self.get_detailed_logging_settings()
            return self._safe_bool_conversion(
                detailed_settings.get("include_raw_labels", True)
            )
        except Exception as e:
    ...
    def should_log_analysis_steps(self) -> bool:
        ...
        try:
            detailed_settings = self.get_detailed_logging_settings()
            return self._safe_bool_conversion(
                detailed_settings.get("analysis_steps", False)
            )
        except Exception as e:
    ...
    def should_log_performance_metrics(self) -> bool:
        ...
        try:
            detailed_settings = self.get_detailed_logging_settings()
            return self._safe_bool_conversion(
                detailed_settings.get("performance_metrics", True)
            )
        except Exception as e:
    ...
    def should_include_reasoning(self) -> bool:
        ...
        try:
            detailed_settings = self.get_detailed_logging_settings()
            return self._safe_bool_conversion(
                detailed_settings.get("include_reasoning", True)
            )
        except Exception as e:
    ...
    def get_component_logging_settings(self) -> Dict[str, Any]:
        ...
        try:
            # PHASE 3E: Enhanced access using get_config_section patterns
            component_settings = self.unified_config.get_config_section(
                "logging_settings", "component_logging", {}
            )
            ...
            return {
                ...
                "model_disagreements": component_settings.get(
                    "model_disagreements", True
                ),
                "staff_review_triggers": component_settings.get(
                    "staff_review_triggers", True
                ),
                "pattern_adjustments": component_settings.get(
                ...
                "ensemble_decisions": component_settings.get(
    ...
    def should_log_threshold_changes(self) -> bool:
        ...
        try:
            ...
            return self._safe_bool_conversion(
                component_settings.get("threshold_changes", True)
            )
        except Exception as e:
    ...
    def should_log_model_disagreements(self) -> bool:
        ...
        try:
            component_settings = self.get_component_logging_settings()
            return self._safe_bool_conversion(
                component_settings.get("model_disagreements", True)
            )
        except Exception as e:
    ...
    def should_log_staff_review_triggers(self) -> bool:
        ...
        try:
            component_settings = self.get_component_logging_settings()
            return self._safe_bool_conversion(
                component_settings.get("staff_review_triggers", True)
            )
        except Exception as e:
    ...
    def should_log_pattern_adjustments(self) -> bool:
        ...
        try:
            component_settings = self.get_component_logging_settings()
            return self._safe_bool_conversion(
                component_settings.get("pattern_adjustments", True)
            )
        except Exception as e:
    ...
    def should_log_learning_updates(self) -> bool:
        ...
        try:
            component_settings = self.get_component_logging_settings()
            return self._safe_bool_conversion(
                component_settings.get("learning_updates", True)
            )
        except Exception as e:
    ...
    def should_log_label_mappings(self) -> bool:
        ...
        try:
            component_settings = self.get_component_logging_settings()
            return self._safe_bool_conversion(
                component_settings.get("label_mappings", True)
            )
        except Exception as e:
    ...
    def should_log_ensemble_decisions(self) -> bool:
        ...
        try:
            component_settings = self.get_component_logging_settings()
            return self._safe_bool_conversion(
                component_settings.get("ensemble_decisions", True)
            )
        except Exception as e:
    ...
    def should_log_crisis_detection(self) -> bool:
        ...
        try:
            component_settings = self.get_component_logging_settings()
            return self._safe_bool_conversion(
                component_settings.get("crisis_detection", True)
            )
        except Exception as e:
    ...
    def get_development_logging_settings(self) -> Dict[str, Any]:
        ...
        try:
            # PHASE 3E: Enhanced access using get_config_section patterns
            dev_settings = self.unified_config.get_config_section(
                "logging_settings", "development_logging", {}
            )
            if not dev_settings:
                # Fallback to direct logging_config access
            ...
            return {
                ...
                "log_configuration_loading": dev_settings.get(
                    "log_configuration_loading", False
                ),
                "log_manager_initialization": dev_settings.get(
                    "log_manager_initialization", True
                ),
                "log_environment_variables": dev_settings.get(
    ...
    def should_log_configuration_loading(self) -> bool:
        ...
        try:
            dev_settings = self.get_development_logging_settings()
            return self._safe_bool_conversion(
                dev_settings.get("log_configuration_loading", False)
            )
        except Exception as e:
    ...
    def should_log_manager_initialization(self) -> bool:
        ...
        try:
            dev_settings = self.get_development_logging_settings()
            return self._safe_bool_conversion(
                dev_settings.get("log_manager_initialization", True)
            )
        except Exception as e:
    ...
    def should_log_environment_variables(self) -> bool:
        ...
        try:
            dev_settings = self.get_development_logging_settings()
            return self._safe_bool_conversion(
                dev_settings.get("log_environment_variables", False)
            )
        except Exception as e:
...
def create_logging_config_manager(unified_config_manager) -> LoggingConfigManager:
    ...
    if not unified_config_manager:
        raise ValueError(
            "UnifiedConfigManager is required for LoggingConfigManager factory"
        )
...
logger.info(
    "LoggingConfigManager v3.1e-5.5-4 loaded - Phase 3e Sub-step 5.5 cleanup complete with enhanced patterns"
)
