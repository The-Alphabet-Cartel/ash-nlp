...
class ConfigManager:
    """
    Configuration Manager for Ash-NLP Crisis Detection System
    ...
    def get_model_config(self, model_name: str) -> Dict[str, Any]:
        ...
        Args:
            model_name: Model identifier (bart, sentiment, irony, emotions)

        Returns:
            Model configuration dictionary
        """
        section_name = f"model_{model_name}"
        return self.get_section(section_name)

    def get_all_model_configs(self) -> Dict[str, Dict[str, Any]]:
        """
        Get configuration for all enabled models.
