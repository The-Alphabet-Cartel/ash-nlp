...
ENV NLP_ENSEMBLE_HIGH_CRISIS_THRESHOLD="0.50"
ENV NLP_ENSEMBLE_MEDIUM_CRISIS_THRESHOLD="0.30"
ENV NLP_ENSEMBLE_LOW_CRISIS_THRESHOLD="0.15"
...
# Model weights - Give depression model more influence (adjusted)
ENV NLP_DEPRESSION_MODEL_WEIGHT="0.6"
ENV NLP_SENTIMENT_MODEL_WEIGHT="0.15"
ENV NLP_EMOTIONAL_DISTRESS_MODEL_WEIGHT="0.25"

# Gap detection (more sensitive for development)
ENV NLP_GAP_DETECTION_THRESHOLD="0.3"
ENV NLP_DISAGREEMENT_THRESHOLD="0.4"
ENV NLP_AUTO_FLAG_DISAGREEMENTS="true"
