...
| Model loading utilities | Model-specific operations | ModelCoordinationManager |
...
| **pattern_detection_manager** | `log_pattern_error()` → `handle_error_with_fallback()` | Constructor injection |
