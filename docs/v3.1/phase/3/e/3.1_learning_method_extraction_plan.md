...
- ❌ **`determine_crisis_level()`** - Stays in CrisisThresholdManager
- ❌ **`requires_staff_review()`** - Stays in CrisisThresholdManager  
- ❌ **Core analysis parameters** - Stays in AnalysisConfigManager
